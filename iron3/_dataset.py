...
class Iron3SampleDataset(SampleDataset):
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super(Iron3SampleDataset, self).__init__(*args, **kwargs)

    def _parse_auxiliary_solutions(self, raw_sample: Dict[str, Any]) -> List[AuxiliarySolution]:
        return [
            self._parse_auxiliary_solution("Complexante", raw_sample["complexant"]),
        ]
...
class ProcessedIron3SampleDataset(ProcessedSampleDataset):
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        super(ProcessedIron3SampleDataset, self).__init__(*args, **kwargs)
